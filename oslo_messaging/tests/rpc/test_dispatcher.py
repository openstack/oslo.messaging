...
class TestDispatcher(test_utils.BaseTestCase):
    scenarios = [
        (
            ...
            dict(
                ...
                success=False,
                ex=oslo_messaging.UnsupportedVersion,
            ),
        ),
        (
            'default_target',
        ...
        (
            ...
            dict(
                ...
                ctxt=dict(user='bob'),
                msg=dict(method='bar', args=dict(blaa=True)),
                exposed_methods=['foo', 'bar', '_foobar'],
                success=True,
                ex=None,
            ),
        ...
        (
            ...
            dict(
                ...
                dispatch_to=dict(endpoint=0, method='foo'),
                ctxt={},
                msg=dict(method='foo', namespace=None),
                exposed_methods=['foo', 'bar', '_foobar'],
                success=True,
                ex=None,
            ),
        ...
        (
            ...
            dict(
                ...
                dispatch_to=dict(endpoint=0, method='foo'),
                ctxt={},
                msg=dict(method='foo', version='1.0'),
        ...
        (
            ...
            dict(
                ...
                dispatch_to=None,
                ctxt={},
                msg=dict(method='foobar'),
                exposed_methods=['foo', 'bar'],
                success=False,
                ex=oslo_messaging.NoSuchMethod,
            ),
        ),
        (
            'namespace',
            dict(
                endpoints=[{}, dict(namespace='testns')],
                access_policy=oslo_messaging.DefaultRPCAccessPolicy,
                dispatch_to=dict(endpoint=1, method='foo'),
                ctxt={},
                msg=dict(method='foo', namespace='testns'),
                exposed_methods=['foo', 'bar'],
                success=True,
                ex=None,
            ),
        ...
        (
            ...
            dict(
                ...
                dispatch_to=None,
                ctxt={},
                msg=dict(method='foo', namespace='nstest'),
                exposed_methods=['foo', 'bar'],
                success=False,
                ex=oslo_messaging.UnsupportedVersion,
            ),
        ...
        (
            'version',
            dict(
                endpoints=[dict(version='1.5'), dict(version='3.4')],
                access_policy=oslo_messaging.DefaultRPCAccessPolicy,
                dispatch_to=dict(endpoint=1, method='foo'),
                ctxt={},
                msg=dict(method='foo', version='3.2'),
                exposed_methods=['foo', 'bar'],
                success=True,
                ex=None,
            ),
        ...
        (
            'version_mismatch',
            dict(
                endpoints=[dict(version='1.5'), dict(version='3.0')],
                access_policy=oslo_messaging.DefaultRPCAccessPolicy,
                dispatch_to=None,
                ctxt={},
                msg=dict(method='foo', version='3.2'),
        ...
        (
            ...
            dict(
                endpoints=[dict(namespace='testns', legacy_namespaces=[None])],
                access_policy=oslo_messaging.DefaultRPCAccessPolicy,
                dispatch_to=dict(endpoint=0, method='foo'),
                ctxt={},
                msg=dict(method='foo', namespace=None),
        ...
        (
            ...
            dict(
                endpoints=[
                    dict(
                        namespace='testns', legacy_namespaces=['second', None]
                    )
                ],
                access_policy=oslo_messaging.DefaultRPCAccessPolicy,
                dispatch_to=None,
                ctxt={},
                msg=dict(method='foo', namespace='wrong'),
                exposed_methods=['foo', 'bar'],
                success=False,
                ex=oslo_messaging.UnsupportedVersion,
            ),
        ...
        (
            ...
            dict(
                ...
                ctxt={},
                msg=dict(method='_foobar', namespace='testns'),
                exposed_methods=['foo', 'bar'],
                success=False,
                ex=oslo_messaging.NoSuchMethod,
            ),
        ...
        (
            ...
            dict(
                ...
                dispatch_to=dict(endpoint=0, method='bar'),
                ctxt={},
                msg=dict(method='bar', namespace='testns'),
                exposed_methods=['bar'],
                success=True,
                ex=None,
            ),
    ...
    def test_dispatcher(self):
        ...
        dispatcher = oslo_messaging.RPCDispatcher(
            endpoints, serializer, self.access_policy
        )

        incoming = mock.Mock(
            ctxt=self.ctxt, message=self.msg, client_timeout=0
        )
        ...
        try:
            ...
            self.assertTrue(
                self.success, "Unexpected success of operation during testing"
            )
        ...
        for n, endpoint in enumerate(endpoints):
            for method_name in self.exposed_methods:
                ...
                if (
                    self.dispatch_to
                    and n == self.dispatch_to['endpoint']
                    and method_name == self.dispatch_to['method']
                    and method_name in self.exposed_methods
                ):
                    method.assert_called_once_with(
                        self.ctxt, **self.msg.get('args', {})
                    )
                else:
                    self.assertEqual(0, method.call_count, f'method: {method}')
...
class TestSerializer(test_utils.BaseTestCase):
    scenarios = [
        ('no_args_or_retval', dict(ctxt={}, dctxt={}, args={}, retval=None)),
        (
            'args_and_retval',
            dict(
                ctxt=dict(user='bob'),
    ...
    def test_serializer(self):
        ...
        self.assertEqual(
            expected_calls, serializer.deserialize_entity.mock_calls
        )
