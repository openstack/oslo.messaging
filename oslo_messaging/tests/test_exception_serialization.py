...
class SerializeRemoteExceptionTestCase(test_utils.BaseTestCase):
    ...
    def generate_scenarios(cls):
        cls.scenarios = testscenarios.multiply_scenarios(
            cls._add_remote, cls._exception_types
        )
    ...
    scenarios = [
        ...
        (
            ...
            dict(
                ...
                kwargs={},
                str=(
                    "Remote error: NovaStyleException test\n[{!r}].".format(
                        'traceback\ntraceback\n'
                    )
                ),
                msg=(
        ...
        (
            ...
            dict(
                ...
                kwargs={},
                str=(
                    "Remote error: FarcicalError test\n[{!r}].".format(
                        'traceback\ntraceback\n'
                    )
                ),
                msg=(
