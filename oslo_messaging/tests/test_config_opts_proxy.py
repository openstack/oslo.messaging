...
class TestConfigOptsProxy(test_utils.BaseTestCase):
    def test_rabbit(self):
        ...
        self.config(
            rabbit_retry_interval=1, rabbit_qos_prefetch_count=0, group=group
        )
        dummy_opts = [
            cfg.ListOpt('list_str', item_type=types.String(), default=[]),
            cfg.ListOpt('list_int', item_type=types.Integer(), default=[]),
        ...
        self.assertRaises(
            cfg.NoSuchOptError, conf.__getattr__, 'unknown_group'
        )
    ...
    def test_not_in_group(self):
        ...
        self.assertRaises(
            cfg.NoSuchOptError, drv_cmn.ConfigOptsProxy, self.conf, url, group
        )
    ...
    def test_invalid_value(self):
        ...
        self.assertRaises(
            ValueError, drv_cmn.ConfigOptsProxy, self.conf, url, group
        )
